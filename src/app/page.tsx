    ...
    <div className="min-h-[calc(100vh-4rem)]">
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20 lg:py-32">
          <div className="text-center max-w-3xl mx-auto">
            ...
            {/* Subheadline */}
            <p className="text-lg sm:text-xl text-muted mb-10 animate-slide-up" style={{ animationDelay: '0.1s' }}>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 gradient-hero rounded-2xl flex items-center justify-center shadow-lg shadow-primary/25 group-hover:scale-110 transition-transform">
            ...
            {/* Feature 2 */}
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-secondary to-orange-400 rounded-2xl flex items-center justify-center shadow-lg shadow-secondary/25 group-hover:scale-110 transition-transform">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            {/* Feature 3 */}
            <div className="text-center group">
              <div className="w-20 h-20 mx-auto mb-6 bg-gradient-to-br from-success to-emerald-400 rounded-2xl flex items-center justify-center shadow-lg shadow-success/25 group-hover:scale-110 transition-transform">
                <svg className="w-10 h-10 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
      ...
      <footer className="py-8 border-t border-border">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center text-muted text-sm">
          <p>© 2024 DressAI. Powered by Google Gemini AI.</p>
        </div>
      </footer>
    </div>
  );
