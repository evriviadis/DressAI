...
export default function MobileNav() {
    ...
    return (
        <nav className="md:hidden fixed bottom-0 left-0 right-0 z-40 glass border-t border-primary/10" style={{ boxShadow: '0 -1px 20px rgba(224, 64, 251, 0.06)' }}>
                    ...
                    return (
                        ...
                        >
                            <div className="relative">
                                ...
                                {isActive && (
                                    <div className="absolute -bottom-1 left-1/2 -translate-x-1/2 w-1 h-1 bg-primary rounded-full shadow-[0_0_6px_rgba(224,64,251,0.8)]" />
                                )}
                            </div>
